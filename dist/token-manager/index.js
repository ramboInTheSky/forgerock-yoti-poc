...
var TokenManager = /** @class */ (function () {
    ...
    TokenManager.getTokens = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var tokens, _d, clientId, serverConfig, support, error_1, error_2, storedString, storedValues, verifier, state, authorizeUrlOptions, authorizeUrl, parsedUrl, _e, response, parsedQuery, err_1;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    case 0:
                        tokens = null;
                        _d = Config.get(options), clientId = _d.clientId, serverConfig = _d.serverConfig, support = _d.support;
                        _f.label = 1;
                    case 1:
                        _f.trys.push([1, 3, , 4]);
                    ...
                    case 14:
                        ...
                        return [3 /*break*/, 17];
                    case 15: return [4 /*yield*/, withTimeout(fetch(authorizeUrl, {
                            credentials: 'include',
                            mode: 'cors',
                    ...
                    case 18:
                        ...
                        if ((options === null || options === void 0 ? void 0 : options.login) !== 'redirect') {
